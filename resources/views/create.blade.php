                ...
                <form method="post" action="{{ route('store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            <img id="previewImage" class="img-account-profile rounded-circle mb-2 bigger-image" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="user_phone" placeholder="Personal Number">
                                    @error('user_phone')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="user_address" placeholder="Home Address">
                                @error('user_address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
